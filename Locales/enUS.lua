...
L.spellRenames = "Spell Renames"
L.spellRenames_desc = "Allows you to rename spells displayed in BigWigs messages and bars."
L.resetRenames_desc = "Resets the above renames to their defaults."
L.clear = "Clear"
L.clearRenames_desc = "Clears the above renames so Blizzard's spell name is used where possible."
